CLASS ltcl_scramble_book_dfkkzp DEFINITION FINAL FOR TESTING
  DURATION SHORT
  RISK LEVEL HARMLESS.
...
CLASS ltcl_scramble_book_dfkkzp IMPLEMENTATION.

  METHOD all_fields_are_scrambled.
    " Implicit Check in DB operator method UPDATE_DB
    " Relevant fields:
    " - txtvw, infof, txtrz, zzv_name_org1, zzv_nameauftrg, zzv_zubezauftrg
    TRY.
