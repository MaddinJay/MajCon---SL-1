...
CLASS ltd_db_operator IMPLEMENTATION.
  ...
  METHOD zif_vcd_db_operator~fetch_next_package.
    ...
    IF call_already_done = abap_false.
      ...
      <values> = VALUE tt_sel_table( ( laufd      = '1'
                                       laufi      = '20240101'
                                       orign      = '1'
                                       xvorl      = '1'
                                       payno      = 1
                                       subno      = 1
                                       zbkin      = 'Hans Dampf' "#EC NOTEXT
                                       znme1      = 'Hans'  "#EC NOTEXT
                                       znme2      = 'Dampf' "#EC NOTEXT
                                       zstra      = 'Teststrasse' "#EC NOTEXT
                                       zstr1      = '9'
                                       zstr2      = '5'
                                       zort1      = 'Luzern' "#EC NOTEXT
                                       zort2      = 'Luzern' "#EC NOTEXT
                                       zpst1      = '6006'
                                       zpst2      = '6006'
                                       zortp      = 'Luzern'
                                       zbnkn      = '1234'
  ...
  METHOD zif_vcd_db_operator~move_correspond_source2target.
    ...
    result = NEW zcl_vcd_db_operator_dpayh( )->zif_vcd_db_operator~move_correspond_source2target(
  ...
  METHOD zif_vcd_db_operator~update_db.
    ...
    IF <value_list> <> VALUE tt_sel_table( ( laufd      = '1'
                                       laufi      = '20240101'
                                       orign      = '1'
                                       xvorl      = '1'
                                       payno      = 1
    ...
    AND <value_list> <> VALUE tt_sel_table( ( laufd      = '1'
                                       laufi      = '20240101'
                                       orign      = '1'
                                       xvorl      = '1'
                                       payno      = 1
  ...
  METHOD zif_vcd_db_operator~generate_spec_rule_list.
    " Execute call like in productive workflow
    result = NEW zcl_vcd_db_operator_dpayh( )->zif_vcd_db_operator~generate_spec_rule_list( ).
  ENDMETHOD.
