...
CLASS ltd_db_operator IMPLEMENTATION.
  ...
  METHOD zif_vcd_db_operator~fetch_next_package.
    ...
    IF call_already_done = abap_false.
      ...
      <values> = VALUE tt_sel_table( ( gpart      = '1'
                                       vtref      = '1234'
                                       posnr      = '1'
                                       scposnr    = '1'
  ...
  METHOD zif_vcd_db_operator~move_correspond_source2target.
    ...
    result = NEW zcl_vcd_db_operator_vvscpos( )->zif_vcd_db_operator~move_correspond_source2target(
  ...
  METHOD zif_vcd_db_operator~update_db.
    ...
    IF <value_list> <> VALUE tt_sel_table( ( gpart      = '1'
                                       vtref      = '1234'
                                       posnr      = '1'
                                       scposnr    = '1'
                                       zzv_name_first = 'eebP'
    ...
    AND <value_list> <> VALUE tt_sel_table( ( gpart      = '1'
                                       vtref      = '1234'
                                       posnr      = '1'
                                       scposnr    = '1'
                                       zzv_name_first = 'eebP'
  ...
  METHOD zif_vcd_db_operator~generate_spec_rule_list.
    " Execute call like in productive workflow
    result = NEW zcl_vcd_db_operator_vvscpos( )->zif_vcd_db_operator~generate_spec_rule_list( ).
  ENDMETHOD.
